		...
		(r.prototype.use = function (r, o, c, s) {
			...
			if (((g = g.replace(/^\{\/\}/, '')), !n.modules[h] && layui[h] && (n.modules[h] = g), n.modules[h]))
				...
				;(b.async = !0),
					...
					v.appendChild(b),
					!b.attachEvent || (b.attachEvent.toString && b.attachEvent.toString().indexOf('[native code') < 0) || u
						? b.addEventListener(
								'load',
								function (t) {
									p(t, g)
					...
					: ((function y(o) {
							...
							return ++f > (1e3 * n.timeout) / u
								...
								: void (1989 === parseInt(a.getStyle(l, 'width'))
										? (o === p && l.removeAttribute('lay-status'), l.getAttribute('lay-status') === p ? setTimeout(y, u) : r())
...
!(function (e, t) {
	...
	;(r.formatArr = function (e) {
		...
		(D.prototype.config = { type: 'date', range: !1, format: 'yyyy-MM-dd', value: null, isInitValue: !0, min: '1900-1-1', max: '2099-12-31', trigger: 'click', show: !1, showBottom: !0, isPreview: !0, btns: ['clear', 'now', 'confirm'], lang: 'cn', theme: 'default', position: null, calendar: !1, mark: {}, zIndex: null, done: null, change: null }),
		...
		(D.prototype.init = function () {
			...
			;(a.elem = lay(a.elem)),
				...
				a.elem[0] &&
					...
					i[a.type] || (e.console && console.error && console.error("laydate type error:'" + a.type + "' is not supported"), (a.type = 'date')),
					...
					(a.mark = lay.extend({}, a.calendar && 'cn' === a.lang ? { '0-1-1': '\u5143\u65e6', '0-2-14': '\u60c5\u4eba', '0-3-8': '\u5987\u5973', '0-3-12': '\u690d\u6811', '0-4-1': '\u611a\u4eba', '0-5-1': '\u52b3\u52a8', '0-5-4': '\u9752\u5e74', '0-6-1': '\u513f\u7ae5', '0-9-10': '\u6559\u5e08', '0-9-18': '\u56fd\u803b', '0-10-1': '\u56fd\u5e86', '0-12-25': '\u5723\u8bde' } : {}, a.mark)),
		...
		(D.prototype.render = function () {
			...
			if (
				...
				lay(m).html(
					(function () {
						var e = [],
							t = []
						return (
							'datetime' === a.type && e.push('<span lay-type="datetime" class="' + v + '">' + n.timeTips + '</span>'),
				...
				var u = lay.elem('style'),
					h = ['#{{id}} .layui-laydate-header{background-color:{{theme}};}', '#{{id}} .layui-this{background-color:{{theme}} !important;}']
						.join('')
				...
				'string' == typeof y && y
					? n.EXP_IF.test(y)
						? i.range
							...
							: c(o, y)
						: (n.hint(r.formatError[0] + (i.range ? i.format + ' ' + n.rangeStr + ' ' + i.format : i.format) + r.formatError[1]), (a = !0))
					: y && 'date' === layui._typeof(y)
					? (i.dateTime = n.systemDate(y))
					: ((i.dateTime = n.systemDate()), delete n.startTime, delete n.endDate, u(), delete n.endTime),
				(function () {
					if (n.rangeElem) {
						var e = [n.rangeElem[0].val(), n.rangeElem[1].val()],
				...
				'cn' === s.lang
					? (lay(g[0])
					  ...
					  lay(g[1])
							.attr('lay-type', 'month')
							.html(d.month + 1 + ' \u6708'))
					: (lay(g[0]).attr('lay-type', 'month').html(u.month[d.month]), lay(g[1]).attr('lay-type', 'year').html(d.year)),
				h &&
					(s.range
						? e &&
						  ((o.listYM = [
							...
							if (!lay(this).hasClass(d)) {
								...
								s
									? (lay(o)
											...
											.removeClass(y),
									  lay(this).addClass(y),
									  'month' === n.type && 'year' === e && ((a.listYM[t][0] = l), r && ((t ? a.endDate : i).year = l), a.list('month', t)))
...
!(function (e, t) {
	...
	;(l.anim = ['layer-anim-00', 'layer-anim-01', 'layer-anim-02', 'layer-anim-03', 'layer-anim-04', 'layer-anim-05', 'layer-anim-06']),
		...
		(s.pt.config = { type: 0, shade: 0.3, fixed: !0, move: l[1], title: '&#x4FE1;&#x606F;', offset: 'auto', area: 'auto', closeBtn: 1, time: 0, zIndex: 19891014, maxWidth: 360, anim: 0, isOutAnim: !0, minStack: !0, icon: -1, moveType: 1, resize: !0, scrollbar: !0, tips: 2 }),
						...
						C = function (l, o, r) {
							...
							if (o.hasClass(u)) {
								...
								h.addClass(p),
									...
									h[0] ? l.css({ left: l.position().left + l.width() / 2, width: 0, opacity: 0 }) : l.css({ left: c.position().left + parseFloat(c.css('marginLeft')), top: c.position().top + c.height() - l.height() }),
									(e[r] = setTimeout(
										function () {
...
layui.define(['jquery', 'laytpl', 'lay'], function (e) {
	...
	;(k.prototype.config = { trigger: 'click', content: '', className: '', style: '', show: !1, isAllowSpread: !0, isSpreadItem: !0, data: [], delay: 300 }),
...
layui.define(['jquery', 'lay'], function (e) {
	...
	;(F.prototype.config = { color: '', size: null, alpha: !1, format: 'hex', predefine: !1, colors: ['#009688', '#5FB878', '#1E9FFF', '#FF5722', '#FFB800', '#01AAED', '#999', '#c00', '#ff8c00', '#ffd700', '#90ee90', '#00ced1', '#1e90ff', '#c71585', 'rgb(0, 186, 189)', 'rgb(255, 120, 0)', 'rgb(250, 212, 0)', '#393D49', 'rgba(0,0,0,.5)', 'rgba(255, 69, 0, 0.68)', 'rgba(144, 240, 144, 0.5)', 'rgba(31, 147, 255, 0.73)'] }),
		(F.prototype.render = function () {
			var e = this,
				r = e.config,
				o = i(
					[
						...
						'<span ' + ('rgb' == r.format && r.alpha ? 'class="layui-colorpicker-trigger-bgcolor"' : '') + '>',
							...
							var h = 'string' == typeof r.attr('lay-search'),
								...
								m = t(
									[
										...
										'<div class="' + n + '">',
										'<input type="text" placeholder="' + t.trim(p) + '" ' + ('value="' + t.trim(d ? f.html() : '') + '"') + (!u && h ? '' : ' readonly') + ' class="layui-input' + (h ? '' : ' layui-unselect') + (u ? ' ' + c : '') + '">',
...
layui.define(['laytpl', 'laypage', 'layer', 'form', 'util'], function (e) {
	...
	;(H.prototype.config = { limit: 10, loading: !0, cellMinWidth: 60, defaultToolbar: ['filter', 'exports', 'print'], autoSort: !0, text: { none: '\u65e0\u6570\u636e' } }),
		...
		(H.prototype.events = function () {
			...
			i.elem.on('click', 'input[name="layTableCheckbox"]+', function () {
				...
				o
					...
					layui.event.call(e[0], h, 'checkbox(' + f + ')', v.call(e[0], { checked: n, type: o ? 'all' : 'one' }))
			}),
...
layui.define('jquery', function (e) {
	...
	;(v.prototype.config = { length: 5, text: !1, readonly: !1, half: !1, value: 0, theme: '' }),
		(v.prototype.render = function () {
			...
			;(l.elem = a(l.elem)), l.value > l.length && (l.value = l.length), parseInt(l.value) !== l.value && (l.half || (l.value = Math.ceil(l.value) - l.value < 0.5 ? Math.ceil(l.value) : Math.floor(l.value)))
		...
		g = function (t, a, l) {
			var n = t.document,
				...
				c = {
					...
					help: function () {
						i.open({ type: 2, title: '\u5e2e\u52a9', area: ['600px', '380px'], shadeClose: !0, shade: 0.1, skin: 'layui-layer-msg', content: ['', 'no'] })
					},
				},
...
layui
	...
	.addcss('code.css?v=2', 'skincodecss')
